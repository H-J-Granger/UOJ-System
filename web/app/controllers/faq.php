		...
		<div class="card my-1">
			...
			<div id="collapseThree" class="collapse">
				<div class="card-body">
					...
					<p>C的编译器是 gcc 7.4.0，编译命令：<code>gcc code.c -o code -lm -O2 -DONLINE_JUDGE -fno-asm</code>。</p>
					<p>C++的编译器是 g++ 7.4.0，编译命令：<code>g++ code.cpp -o code -lm -O2 -DONLINE_JUDGE -fno-asm -std=c++14</code>。如果选择 C++03、C++11、C++17 则最后一个参数会分别相应地改为 <code>-std=c++03</code>、<code>-std=c++11</code>、<code>-std=c++17</code>。</p>
